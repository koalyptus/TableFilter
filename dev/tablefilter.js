define(['exports', './event', './dom', './string', './cookie', './types', './array', './helpers', './date', './sort', './modules/store', './modules/gridLayout', './modules/loader', './modules/highlightKeywords', './modules/popupFilter', './modules/dropdown', './modules/checkList', './modules/rowsCounter', './modules/statusBar', './modules/paging', './modules/clearButton', './modules/help', './modules/alternateRows', './modules/colOps'], function (exports, _event, _dom, _string, _cookie, _types, _array, _helpers, _date, _sort, _modulesStore, _modulesGridLayout, _modulesLoader, _modulesHighlightKeywords, _modulesPopupFilter, _modulesDropdown, _modulesCheckList, _modulesRowsCounter, _modulesStatusBar, _modulesPaging, _modulesClearButton, _modulesHelp, _modulesAlternateRows, _modulesColOps) {
    ...
    var global = window,
        isValidDate = _date.DateHelper.isValid,
        formatDate = _date.DateHelper.format,
        doc = global.document;
    ...
    var TableFilter = (function () {
        ...
        function TableFilter(id) {
            ...
            if (!this.tbl || _string.Str.lower(this.tbl.nodeName) !== 'table' || this.getRowsNb() === 0) {
            ...
            if (arguments.length > 1) {
                for (var i = 0; i < arguments.length; i++) {
                    ...
                    switch (_string.Str.lower(argtype)) {
                        case 'number':
                            this.startRow = arg;
                            break;
                        case 'object':
            ...
            for (var j = 0; j < this.nbCells; j++) {
                var cfgCol = f['col_' + j];
                var col = !cfgCol ? this.fltTypeInp : _string.Str.lower(cfgCol);
            ...
            this.Evt = {
                ...
                detectKey: function detectKey(e) {
                    ...
                    if (_evt) {
                        var key = _event.Event.keyCode(_evt);
                        if (key === 13) {
                            o._filter();
                            _event.Event.cancel(_evt);
                            _event.Event.stop(_evt);
                        } else {
                            o.isUserTyping = true;
        ...
        _createClass(TableFilter, [{
            ...
            value: function init() {
                ...
                if (this.rememberGridValues || this.rememberPageNb || this.rememberPageLen) {
                    ...
                    this.Cpt.store = new _modulesStore.Store(this);
                }

                if (this.gridLayout) {
                    // var GridLayout = require('modules/gridLayout').GridLayout;
                    // import {GridLayout} from 'modules/gridLayout';
                    this.Cpt.gridLayout = new _modulesGridLayout.GridLayout(this);
                ...
                if (this.loader) {
                    if (!this.Cpt.loader) {
                        ...
                        this.Cpt.loader = new _modulesLoader.Loader(this);
                    }
                }
                ...
                if (this.highlightKeywords) {
                    ...
                    this.Cpt.highlightKeyword = new _modulesHighlightKeywords.HighlightKeyword(this);
                }
                ...
                if (this.popUpFilters) {
                    if (!this.Cpt.popupFilter) {
                        ...
                        this.Cpt.popupFilter = new _modulesPopupFilter.PopupFilter(this);
                    }
                ...
                if (!this.fltGrid) {
                    ...
                    if (this.isFirstLoad) {
                        ...
                        for (var i = 0; i < n; i++) {
                            ...
                            if (col === undefined) {
                                col = f['col_' + i] === undefined ? this.fltTypeInp : _string.Str.lower(f['col_' + i]);
                            }
                            ...
                            if (col === this.fltTypeSlc || col === this.fltTypeMulti) {
                                if (!this.Cpt.dropdown) {
                                    ...
                                    this.Cpt.dropdown = new _modulesDropdown.Dropdown(this);
                                }
                                ...
                                slc.className = _string.Str.lower(col) === this.fltTypeSlc ? inpclass : this.fltMultiCssClass; // for ie<=6
                                ...
                                _event.Event.add(slc, 'keypress', this.Evt.detectKey);
                                _event.Event.add(slc, 'change', this.Evt.onSlcChange);
                                _event.Event.add(slc, 'focus', this.Evt.onSlcFocus);
                            ...
                            // checklist
                                ...
                                if (!this.Cpt.checkList) {
                                    ...
                                    this.Cpt.checkList = new _modulesCheckList.CheckList(this);
                                ...
                                if (this.fillSlcOnDemand) {
                                    _event.Event.add(divCont, 'click', this.Evt.onCheckListClick);
                                    divCont.appendChild(_dom.Dom.text(checkList.activateCheckListTxt));
                                }

                                _event.Event.add(divCont, 'click', this.Evt.onCheckListFocus);
                            } else {
                                //show/hide input
                ...
                if (this.rowsCounter) {
                    ...
                    this.Cpt.rowsCounter = new _modulesRowsCounter.RowsCounter(this);
                    this.Cpt.rowsCounter.init();
                }
                if (this.statusBar) {
                    // var StatusBar = require('modules/statusBar').StatusBar;
                    // import {StatusBar} from 'modules/statusBar';
                    this.Cpt.statusBar = new _modulesStatusBar.StatusBar(this);
                ...
                if (this.paging || this.Cpt.paging && this.Cpt.paging.isPagingRemoved) {
                    ...
                    // if(!this.Cpt.paging){
                    this.Cpt.paging = new _modulesPaging.Paging(this);
                    // }
                ...
                if (this.btnReset) {
                    ...
                    this.Cpt.clearButton = new _modulesClearButton.ClearButton(this);
                    this.Cpt.clearButton.init();
                }
                if (this.helpInstructions) {
                    // var Help = require('modules/help').Help;
                    // import {Help} from 'modules/help';
                    this.Cpt.help = new _modulesHelp.Help(this);
                    this.Cpt.help.init();
                }
                ...
                if (this.alternateBgs) {
                    ...
                    this.Cpt.alternateRows = new _modulesAlternateRows.AlternateRows(this);
                ...
                if (this.hasColOperation) {
                    ...
                    this.Cpt.colOps = new _modulesColOps.ColOps(this);
                    ...
                    for (var j = this.refRow; j < this.nbRows; j++) {
                        ...
                        try {
                            ...
                            for (var x = 0; x < attribs.length; x++) {
                                if (_string.Str.lower(attribs.nodeName) === 'validrow') {
            ...
            value: function _filter() {
                ...
                var re_le = new RegExp(this.leOperator),
                    ...
                    re_lk = new RegExp(_string.Str.rgxEsc(this.lkOperator)),
                    ...
                    re_re = new RegExp(_string.Str.rgxEsc(this.rgxOperator));
                ...
                function hasArg(sA, cell_data, j) {
                    ...
                    if (isValidDate(cell_data, dtType)) {
                        ...
                        //empty
                            ...
                            occurence = _string.Str.isEmpty(cell_data);
                        }
                        //non-empty
                        else if (hasNM) {
                            occurence = !_string.Str.isEmpty(cell_data);
                ...
                for (var k = this.refRow; k < this.nbRows; k++) {
                    ...
                    for (var j = 0; j < nchilds; j++) {
                        ...
                        var cell_data = _string.Str.matchCase(this.getCellData(j, cell[j]), this.matchCase);
                        ...
                        //single search parameter
                            ...
                            occurence[j] = hasArg(_string.Str.trim(sA), cell_data, j);
            ...
            value: function applyGridProps() {
                ...
                if (this.activeFlt && _string.Str.lower(this.activeFlt.nodeName) === this.fltTypeSlc && !this.popUpFilters) {
                    this.activeFlt.blur();
                    ...
                    if (nchilds == this.nbCells && !isExludedRow) {
                        ...
                        for (var j = 0; j < nchilds; j++) {
                            if (j === colindex && row[i].style.display === '') {
                                var cell_data = _string.Str.lower(this.getCellData(j, cell[j])),
            ...
            value: function getFiltersValue() {
                ...
                for (var i = 0; i < this.fltIds.length; i++) {
                    searchArgs.push(_string.Str.trim(_string.Str.matchCase(this.getFilterValue(i), this.matchCase)));
                }
                return searchArgs;
            }
        }, {
            ...
            value: function getFiltersByType(type, bool) {
                ...
                for (var i = 0; i < this.fltIds.length; i++) {
                    ...
                    if (fltType === _string.Str.lower(type)) {
            ...
            value: function validateRow(rowIndex, isValid) {
                ...
                if (!row || _string.Str.lower(typeof isValid) !== 'boolean') {
                    return;
                }
            ...
            value: function setFilterValue(index, searcharg, doFilter) {
                ...
                //checklist
                    ...
                    searcharg = _string.Str.matchCase(searcharg, this.matchCase);
                    ...
                    for (var k = 0; k < _dom.Dom.tag(slc, 'li').length; k++) {
                        var li = _dom.Dom.tag(slc, 'li')[k],
                            ...
                            lblTxt = _string.Str.matchCase(_dom.Dom.getText(lbl), this.matchCase);
            ...
            value: function _containsStr(arg, data, fltType, forceMatch) {
                ...
                if (exactMatch || fltType !== this.fltTypeInp && fltType) {
                    regexp = new RegExp('(^\\s*)' + _string.Str.rgxEsc(arg) + '(\\s*$)', modifier);
                } else {
                    regexp = new RegExp(_string.Str.rgxEsc(arg), modifier);
                }
            ...
            value: function includeFile(fileId, filePath, callback, type) {
                ...
                if (_string.Str.lower(ftype) === 'link') {
