...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.formatDate = exports.isValidDate = undefined;
	...
	var isValidDate = exports.isValidDate = function isValidDate(dateStr, format) {
	    _sugarDate.Date.setLocale('it');
	    console.log(_sugarDate.Date.getAllLocales());
	    ...
	    var d = _sugarDate.Date.create(dateStr);
	    console.log(dateStr + ' is valid date', d, _sugarDate.Date.isValid(d));
	    ...
	    if (format.length !== 3) {
	        if (format === 'DDMMMYYYY') {
	            var _d = formatDate(dateStr, format);
	            dateStr = _d.getDate() + '/' + (_d.getMonth() + 1) + '/' + _d.getFullYear();
	            format = 'DMY';
	        }
	    }
