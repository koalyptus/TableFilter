...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "tf-" + ({}[chunkId]||chunkId) + "-" + {"1":"05a734fa5f686a5bcd3d"}[chunkId] + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableFilter = exports.TableFilter = function () {
	    ...
	    TableFilter.prototype.getFilteredDataCol = function getFilteredDataCol(colIndex) {
	        ...
	        var colValues = this.getColValues(colIndex, includeHeaders, num, exclude);
	        ...
	        var validRows = this.getValidRows(true).filter(function (rowIdx) {
	            return exclude.indexOf(rowIdx) === -1 && _this7.getRowDisplay(rows[rowIdx]) !== 'none';
	        });
	        ...
	        var validColValues = validRows.map(function (rowIdx) {
	            var val = _this7.getCellData(rows[rowIdx].cells[colIndex]);
	            return num ? Number(val) || (0, _number.parse)(val, decimal) : val;
	        });
	
	        // retain column values in valid rows only
	        colValues = colValues.filter(function (value) {
