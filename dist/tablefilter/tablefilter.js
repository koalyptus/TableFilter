	    ...
	    _createClass(TableFilter, [{
	        ...
	        value: function destroy() {
	            ...
	            if (this.markActiveColumns) {
	                ...
	                this.emitter.off(['before-filtering'], function () {
	                    return _this4.clearActiveColumns();
	                });
	                this.emitter.off(['cell-processed'], function (tf, colIndex) {
	                    return _this4.markActiveColumn(colIndex);
	                });
	            }
	            if (this.hasExtensions) {
	            ...
	            if (this.hasVisibleRows) {
	                this.emitter.off(['after-filtering'], function () {
	                    return _this4.enforceVisibility();
	                });
	            }
	            if (this.linkedFilters) {
	                this.emitter.off(['after-filtering'], function () {
	        ...
	        value: function _resetGrid() {
	            ...
	            if (!this.gridLayout) {
	                ...
	                _dom2.default.addClass(tbl, this.prfxTf);
	            }
	...
	var Dropdown = exports.Dropdown = (function (_Feature) {
	    ...
	    _createClass(Dropdown, [{
	        ...
	        value: function init(colIndex, isExternal, container) {
	            ...
	            _event2.default.add(slc, 'keypress', tf.Evt.detectKey.bind(tf));
	            _event2.default.add(slc, 'change', tf.Evt.onSlcChange.bind(tf));
	            _event2.default.add(slc, 'focus', tf.Evt.onSlcFocus.bind(tf));
