  ...
  _createClass(BaseDropdown, [{
    ...
    value: function sortOptions(colIndex) {
      ...
      if (this.customSorter && this.customSorter.col.indexOf(colIndex) !== -1) {
        ...
        var comparer = _sort__WEBPACK_IMPORTED_MODULE_1__["numSortAsc"];

        if (sortNumDesc === true || sortNumDesc.indexOf(colIndex) !== -1) {
          comparer = _sort__WEBPACK_IMPORTED_MODULE_1__["numSortDesc"];
        }
        ...
        var _comparer = _sort__WEBPACK_IMPORTED_MODULE_1__["dateSortAsc"];
...
function (_Feature) {
  ...
  function Paging(tf) {
    ...
    var o = _assertThisInitialized(_assertThisInitialized(_this));
    /**
...
/*!***********************!*\
  !*** ./src/string.js ***!
  \***********************/
/*! exports provided: trim, isEmpty, rgxEsc, matchCase, contains, toCamelCase */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  function TableFilter() {
    ...
    args.forEach(function (arg) {
      if (_typeof(arg) === 'object' && arg.nodeName === 'TABLE') {
        _this.tbl = arg;
        _this.id = arg.id || "tf_".concat(new Date().getTime(), "_");
    ...
    this.clearFilterText = Object(_settings__WEBPACK_IMPORTED_MODULE_5__["defaultsStr"])(f.clear_filter_text, 'Clear');
    /**
    ...
    this.sortSlc = Object(_types__WEBPACK_IMPORTED_MODULE_3__["isUndef"])(f.sort_select) ? true : Object(_types__WEBPACK_IMPORTED_MODULE_3__["isArray"])(f.sort_select) ? f.sort_select : Boolean(f.sort_select);
    /**
