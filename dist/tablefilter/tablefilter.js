...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "tf-" + ({}[chunkId]||chunkId) + "-" + {"0":"af6ead871ce7bf6ae22d"}[chunkId] + ".js";
...
var Toolbar = exports.Toolbar = function (_Feature) {
  ...
  function Toolbar(tf) {
     ...
     * @type {String}
     */
    _this.infDivCssClass = (0, _settings.defaultsStr)(f.inf_div_css_class, 'inf');

    /**
     * Css class for left-side inner container DOM element
     * @type {String}
     */
    _this.lDivCssClass = (0, _settings.defaultsStr)(f.left_div_css_class, 'ldiv');

    /**
     * Css class for right-side inner container DOM element
     * @type {String}
     */
    _this.rDivCssClass = (0, _settings.defaultsStr)(f.right_div_css_class, 'rdiv');

    /**
     * Css class for middle inner container DOM element
     * @type {String}
     */
    _this.mDivCssClass = (0, _settings.defaultsStr)(f.middle_div_css_class, 'mdiv');

    /**
     * Toolbar's custom container ID
     * @type {String}
     */
    _this.toolBarTgtId = (0, _settings.defaultsStr)(f.toolbar_target_id, null);
...
var RowsCounter = exports.RowsCounter = function (_Feature) {
    ...
    _createClass(RowsCounter, [{
        ...
        value: function init() {
            ...
            //     tf.setToolbar();
            // }
            var targetEl = !this.targetId ? /*tf.lDiv*/
            tf.feature('toolbar').container(this.toolbarPosition) : (0, _dom.elm)(this.targetId);
...
var ClearButton = exports.ClearButton = function (_Feature) {
  ...
  _createClass(ClearButton, [{
    ...
    value: function init() {
      ...
      var targetEl = !this.targetId ? /*tf.rDiv*/
      tf.feature('toolbar').container(this.toolbarPosition) : (0, _dom.elm)(this.targetId);
...
var Paging = exports.Paging = function (_Feature) {
    ...
    _createClass(Paging, [{
        ...
        value: function init() {
            ...
            //     tf.setToolbar();
            // }
            var targetEl = !this.tgtId ? /*tf.mDiv*/
            tf.feature('toolbar').container(this.toolbarPosition) : (0, _dom.elm)(this.tgtId);
