...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "tf-" + ({}[chunkId]||chunkId) + "-" + {"0":"7b0178d04d1f1b11a7f0"}[chunkId] + ".js";
...
var _gridLayout = __webpack_require__(114);
...
var _clearButton = __webpack_require__(113);

var _alternateRows = __webpack_require__(112);
...
var _diacritics = __webpack_require__(126);
...
var _sort = __webpack_require__(67);
...
var Dropdown = exports.Dropdown = function (_Feature) {
    ...
    Dropdown.prototype.sortOptions = function sortOptions(colIndex) {
        ...
        if (tf.hasType(colIndex, [_const.STRING])) {
            console.log('sorting', colIndex, _const.STRING);
            var compareFn = caseSensitive ? undefined : _sort.ignoreCase;
            options.sort(compareFn);
        } else if (tf.hasType(colIndex, [_const.NUMBER, _const.FORMATTED_NUMBER])) {
            console.log('sorting', colIndex, _const.FORMATTED_NUMBER);
            var decimal = tf.getDecimal(colIndex);
            var _compareFn = _sort.numSortAsc;
            if (sortNumDesc === true || sortNumDesc.indexOf(colIndex) !== -1) {
                _compareFn = _sort.numSortDesc;
            }
            options.sort((0, _sort.sortNumberStr)(_compareFn, decimal));
        } else if (tf.hasType(colIndex, [_const.DATE, _const.FORMATTED_DATE])) {
            console.log('sorting', colIndex, _const.DATE);
            var locale = this.tf.feature('dateType').getLocale(colIndex);
            var _compareFn2 = _sort.dateSortAsc;
            options.sort((0, _sort.sortDateStr)(_compareFn2, locale));
        }
...
var classChecks = __webpack_require__(3),
    simpleClone = __webpack_require__(42),
    isObjectType = __webpack_require__(53),
    getDateParamsFromString = __webpack_require__(212),
    collectDateParamsFromArguments = __webpack_require__(204);
...
var LocaleHelpers = __webpack_require__(7),
    ...
    classChecks = __webpack_require__(3),
    assertDateIsValid = __webpack_require__(80),
    getAdjustedUnitForDate = __webpack_require__(208);
...
var LocaleHelpers = __webpack_require__(7),
    trim = __webpack_require__(149),
    getMonth = __webpack_require__(29),
    isDefined = __webpack_require__(27),
    getNewDate = __webpack_require__(40),
    compareDay = __webpack_require__(205),
    getWeekday = __webpack_require__(20),
    dateIsValid = __webpack_require__(45),
    classChecks = __webpack_require__(3),
...
var getOwnKey = __webpack_require__(137);
...
var ISODefaults = __webpack_require__(63),
    getDate = __webpack_require__(34),
    setDate = __webpack_require__(35),
    setYear = __webpack_require__(227),
    getYear = __webpack_require__(30),
    getMonth = __webpack_require__(29),
    setMonth = __webpack_require__(226),
    cloneDate = __webpack_require__(33),
    getWeekday = __webpack_require__(20),
    setWeekday = __webpack_require__(24),
    classChecks = __webpack_require__(3),
...
var _storage = __webpack_require__(124);
...
var TableFilter = exports.TableFilter = function () {
    ...
    TableFilter.prototype.getCellData = function getCellData(cell) {
        ...
        if (this.hasType(colIndex, [_const.FORMATTED_NUMBER])) {
            var decimal = this.getDecimal(colIndex);
...
var STRING_FORMAT_REG = __webpack_require__(154),
    CommonChars = __webpack_require__(44),
    memoizeFunction = __webpack_require__(144);
...
var simpleClone = __webpack_require__(42),
    defineAccessor = __webpack_require__(131),
    coreUtilityAliases = __webpack_require__(11);
...
var isClass = __webpack_require__(75),
    isObjectType = __webpack_require__(53),
    hasOwnEnumeratedProperties = __webpack_require__(139),
    hasValidPlainObjectPrototype = __webpack_require__(140);
...
var getSparseArrayIndexes = __webpack_require__(138);
...
var INTERNAL_MEMOIZE_LIMIT = __webpack_require__(151),
    coreUtilityAliases = __webpack_require__(11);
...
var PRIVATE_PROP_PREFIX = __webpack_require__(153),
    coreUtilityAliases = __webpack_require__(11);
...
var CommonChars = __webpack_require__(44),
    ...
    allCharsReg = __webpack_require__(127);
...
var setDateChainableConstructor = __webpack_require__(225);
...
var map = __webpack_require__(76),
    escapeRegExp = __webpack_require__(133);
...
var LOCALE_ARRAY_FIELDS = __webpack_require__(293),
    ISODefaults = __webpack_require__(63),
    ParsingTokens = __webpack_require__(102),
    CoreParsingFormats = __webpack_require__(289),
    LocalizedParsingTokens = __webpack_require__(100),
    map = __webpack_require__(76),
    filter = __webpack_require__(134),
    forEach = __webpack_require__(26),
    isDefined = __webpack_require__(27),
    commaSplit = __webpack_require__(129),
    classChecks = __webpack_require__(3),
    isUndefined = __webpack_require__(37),
    mathAliases = __webpack_require__(6),
    simpleMerge = __webpack_require__(56),
    getOrdinalSuffix = __webpack_require__(136),
    getRegNonCapturing = __webpack_require__(91),
    coreUtilityAliases = __webpack_require__(11),
    getArrayWithOffset = __webpack_require__(210),
    iterateOverDateUnits = __webpack_require__(61),
    arrayToRegAlternates = __webpack_require__(199),
    fullwidthNumberHelpers = __webpack_require__(155),
    getAdjustedUnitForNumber = __webpack_require__(209),
    getParsingTokenWithSuffix = __webpack_require__(218);
...
var createDate = __webpack_require__(28),
    namespaceAliases = __webpack_require__(22),
    setChainableConstructor = __webpack_require__(148);
...
var Sugar = __webpack_require__(0),
    DateUnitIndexes = __webpack_require__(5),
    moveToBeginningOfUnit = __webpack_require__(47),
    getUnitIndexForParamName = __webpack_require__(219);
...
var defaultNewDate = __webpack_require__(206);
...
var TIMEZONE_ABBREVIATION_REG = __webpack_require__(295),
    LocaleHelpers = __webpack_require__(7),
    DateUnitIndexes = __webpack_require__(5),
    trunc = __webpack_require__(23),
    getDate = __webpack_require__(34),
    ...
    callDateGet = __webpack_require__(18),
    mathAliases = __webpack_require__(6),
    getWeekYear = __webpack_require__(220),
    getUTCOffset = __webpack_require__(92),
    getDaysSince = __webpack_require__(213),
    getWeekNumber = __webpack_require__(60),
    getMeridiemToken = __webpack_require__(215),
    setUnitAndLowerToEdge = __webpack_require__(36);
...
var BritishEnglishDefinition = __webpack_require__(287),
    AmericanEnglishDefinition = __webpack_require__(98),
    CanadianEnglishDefinition = __webpack_require__(288);
...
var LocaleHelpers = __webpack_require__(7),
    FormatTokensBase = __webpack_require__(292),
    ...
    namespaceAliases = __webpack_require__(22),
    coreUtilityAliases = __webpack_require__(11),
    createFormatMatcher = __webpack_require__(130),
    defineInstanceSimilar = __webpack_require__(41);
...
var periodSplit = __webpack_require__(145);
