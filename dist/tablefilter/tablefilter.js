...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modulesNoResults = __webpack_require__(24);
	...
	var TableFilter = (function () {
	    ...
	    _createClass(TableFilter, [{
	        ...
	        value: function loadExtension(ext) {
	            ...
	            __webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(25)("./" + modulePath)]; (function (mod) {
	                var inst = new mod(_this3, ext);
	                inst.init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoResults = (function (_Feature) {
	    ...
	    function NoResults(tf) {
	        ...
	        _get(Object.getPrototypeOf(NoResults.prototype), 'constructor', this).call(this, tf, 'noResults');
	
	        //configuration object
	        var f = this.config.no_results_message;
	
	        this.text = f.text || 'No results';
	        this.customContainer = f.custom_container || null;
	        this.customContainerId = f.custom_container_id || null;
	        this.isExternal = !_types2['default'].isEmpty(this.customContainer) || !_types2['default'].isEmpty(this.customContainerId);
	    ...
	    _createClass(NoResults, [{
	        ...
	        value: function init() {
	            ...
	            cont.appendChild(_dom2['default'].text(this.text));
