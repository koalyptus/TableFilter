	    ...
	    _createClass(Loader, [{
	        ...
	        value: function show(p) {
	            ...
	            var displayLoader = function displayLoader() {
	                ...
	                if (_this2.onShowLoader && p !== 'none') {
	                    _this2.onShowLoader.call(null, _this2);
	                }
	                _this2.loaderDiv.style.display = p;
	                if (_this2.onHideLoader && p === 'none') {
	                    _this2.onHideLoader.call(null, _this2);
	                }
	            };
	...
	var RowsCounter = exports.RowsCounter = (function (_Feature) {
	    ...
	    _createClass(RowsCounter, [{
	        ...
	        value: function init() {
	            ...
	            this.emitter.on('grouped-by-page', function () {
	                return _this2.refresh(tf.nbVisibleRows);
	            });
	        ...
	        value: function destroy() {
	            ...
	            this.emitter.off('grouped-by-page', function () {
	                return _this3.refresh(tf.nbVisibleRows);
	            });
	    ...
	    _createClass(StatusBar, [{
	        ...
	        value: function message() {
	            ...
	            global.setTimeout(function () {
	                _this2.statusBarSpan.innerHTML = t;
	                if (_this2.onAfterShowMsg) {
	                    _this2.onAfterShowMsg.call(null, _this2.tf, t);
	                }
	            }, d);
	        }
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Paging = exports.Paging = (function (_Feature) {
	    ...
	    function Paging(tf) {
	        ...
	        var start_row = _this.refRow;
	        var nrows = _this.nbRows;
	        //calculates page nb
	...
	var AlternateRows = exports.AlternateRows = (function (_Feature) {
	    ...
	    _createClass(AlternateRows, [{
	        ...
	        value: function init() {
	            ...
	            this.emitter.on('row-processed', function (tf, rowIndex, isValid) {
	                return _this2.processRow(tf, rowIndex, isValid);
	            });
	        ...
	        key: 'processRow',
	        value: function processRow(tf, rowIdx, isValid) {
	        ...
	        value: function destroy() {
	            ...
	            this.emitter.off('row-processed', function (tf, rowIndex, isValid) {
	                return _this3.processRow(tf, rowIndex, isValid);
	            });
