...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableFilter = exports.TableFilter = function () {
	    ...
	    TableFilter.prototype._buildInputFilter = function _buildInputFilter(colIndex, cssClass, container) {
	        ...
	        _event2.default.add(inp, 'focus', function (evt) {
	            return _this3.onInpFocus(evt);
	        });
	
	        //filter is appended in custom element
	        if (externalFltTgtId) {
	            (0, _dom.byId)(externalFltTgtId).appendChild(inp);
	        ...
	        _event2.default.add(inp, 'keypress', function (evt) {
	            return _this3.detectKey(evt);
	        });
	        _event2.default.add(inp, 'keydown', function () {
	            return _this3.onKeyDown();
	        });
	        _event2.default.add(inp, 'keyup', function (evt) {
	            return _this3.onKeyUp(evt);
	        });
	        _event2.default.add(inp, 'blur', function () {
	    ...
	    TableFilter.prototype._buildSubmitButton = function _buildSubmitButton(colIndex, container) {
	        ...
	        //filter is appended in custom element
	        if (externalFltTgtId) {
	            (0, _dom.byId)(externalFltTgtId).appendChild(btn);
	        } else {
	    ...
	    TableFilter.prototype.getStylesheet = function getStylesheet() {
	        ...
	        return (0, _dom.byId)(this.prfxTf + name);
	    };
	    ...
	    TableFilter.prototype.setToolbar = function setToolbar() {
	        ...
	        if (this.toolBarTgtId) {
	            (0, _dom.byId)(this.toolBarTgtId).appendChild(infdiv);
	        }
	        //grid-layout
	        ...
	        this.infDiv = (0, _dom.byId)(this.prfxInfDiv + this.id);
	
	        /*** left div containing rows # displayer ***/
	        var ldiv = (0, _dom.createElm)('div', ['id', this.prfxLDiv + this.id]);
	        ldiv.className = this.lDivCssClass;
	        infdiv.appendChild(ldiv);
	        this.lDiv = (0, _dom.byId)(this.prfxLDiv + this.id);
	        ...
	        this.rDiv = (0, _dom.byId)(this.prfxRDiv + this.id);
	
	        /*** mid div containing paging elements ***/
	        var mdiv = (0, _dom.createElm)('div', ['id', this.prfxMDiv + this.id]);
	        mdiv.className = this.mDivCssClass;
	        infdiv.appendChild(mdiv);
	        this.mDiv = (0, _dom.byId)(this.prfxMDiv + this.id);
	    ...
	    TableFilter.prototype.removeExternalFlts = function removeExternalFlts() {
	        ...
	        for (var ct = 0; ct < len; ct++) {
	            var externalFltTgtId = ids[ct],
	                externalFlt = (0, _dom.byId)(externalFltTgtId);
	            if (externalFlt) {
	    ...
	    TableFilter.prototype.linkFilters = function linkFilters() {
	        ...
	        for (var i = 0, len = slcIndex.length; i < len; i++) {
	            var curSlc = (0, _dom.byId)(this.fltIds[slcIndex[i]]);
	    ...
	    TableFilter.prototype.isImported = function isImported(filePath, type) {
	        var imported = false,
	            ...
	            files = (0, _dom.tag)(doc, importType);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    target: function target(evt) {
	        return evt && evt.target || _root.root.event && _root.root.event.srcElement;
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.tag = exports.byId = exports.createCheckItem = exports.createOpt = exports.removeClass = exports.addClass = exports.hasClass = exports.createText = exports.removeElm = exports.createElm = exports.getFirstTextNode = exports.getText = undefined;
	 ...
	 */
	var createElm = exports.createElm = function createElm(tag) {
	    if ((0, _types.isUndef)(tag)) {
	        return;
	    }
	...
	var createOpt = exports.createOpt = function createOpt(text, value, isSel) {
	    var isSelected = isSel ? true : false,
	        opt = isSelected ? createElm('option', ['value', value], ['selected', 'true']) : createElm('option', ['value', value]);
	...
	var byId = exports.byId = function byId(key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridLayout = exports.GridLayout = function (_Feature) {
	    ...
	    function GridLayout(tf) {
	        ...
	        _this.gridEnableFilters = !(0, _types.isUndef)(f.grid_enable_default_filters) ? f.grid_enable_default_filters : true;
	    ...
	    GridLayout.prototype.init = function init() {
	        ...
	        var createColTags = function createColTags() {
	            for (var _k = tf.nbCells - 1; _k >= 0; _k--) {
	                var col = (0, _dom.createElm)('col', ['id', tf.id + '_col_' + _k]);
	        ...
	        var afterColResizedFn = (0, _types.isFn)(f.on_after_col_resized) ? f.on_after_col_resized : null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = exports.Loader = function (_Feature) {
	    ...
	    Loader.prototype.init = function init() {
	        ...
	        var targetEl = !this.loaderTgtId ? tf.tbl.parentNode : (0, _dom.id)(this.loaderTgtId);
	        if (!this.loaderTgtId) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PopupFilter = exports.PopupFilter = function (_Feature) {
	    ...
	    PopupFilter.prototype.onClick = function onClick(evt) {
	        var elm = _event2.default.target(evt).parentNode,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dropdown = exports.Dropdown = function (_Feature) {
	    ...
	    Dropdown.prototype.init = function init(colIndex, isExternal, container) {
	        ...
	        if (externalFltTgtId) {
	            (0, _dom.id)(externalFltTgtId).appendChild(slc);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckList = exports.CheckList = function (_Feature) {
	    ...
	    CheckList.prototype.init = function init(colIndex, isExternal, container) {
	        ...
	        var divCont = (0, _dom.createElm)('div', ['id', this.prfxCheckListDiv + colIndex + '_' + tf.id], ['ct', colIndex], ['filled', '0']);
	        divCont.className = this.checkListDivCssClass;
	
	        //filter is appended in desired element
	        if (externalFltTgtId) {
	            (0, _dom.byId)(externalFltTgtId).appendChild(divCont);
	        ...
	        if (!tf.loadFltOnDemand) {
	            ...
	            divCont.appendChild((0, _dom.createText)(this.activateCheckListTxt));
	        }
	            ...
	            for (var j = 0; j < ncells; j++) {
	                ...
	                if (colIndex === j && (!tf.linkedFilters || tf.linkedFilters && tf.disableExcludedOptions) || colIndex === j && tf.linkedFilters && (rows[k].style.display === '' && !tf.paging || tf.paging && (!activeIdx || activeIdx === colIndex || activeIdx !== colIndex && tf.validRowsIndex.indexOf(k) !== -1))) {
	                    ...
	                    if (tf.linkedFilters && tf.disableExcludedOptions) {
	                        ...
	                        if (!(0, _array.has)(filteredCol, cellString, tf.matchCase) && !(0, _array.has)(this.excludedOpts, cellString, tf.matchCase)) {
	    ...
	    CheckList.prototype.addChecks = function addChecks(colIndex, ul) {
	        ...
	        for (var y = 0; y < this.opts.length; y++) {
	            ...
	            if (tf.linkedFilters && tf.disableExcludedOptions && (0, _array.has)(this.excludedOpts, (0, _string.matchCase)(val, tf.matchCase), tf.matchCase)) {
	                (0, _dom.addClass)(li, this.checkListItemDisabledCssClass);
	    ...
	    CheckList.prototype.setCheckListValues = function setCheckListValues(o) {
	        ...
	        if (o.checked) {
	            ...
	            if (chkValue === '') {
	                if (fltIndexes && fltIndexes !== '') {
	                    ...
	                    for (var u = 0; u < indSplit.length; u++) {
	                        //checked item
	                        var cChk = (0, _dom.byId)(tf.fltIds[colIndex] + '_' + indSplit[u]);
	                        if (cChk) {
	                            cChk.checked = false;
	                            (0, _dom.removeClass)(n.childNodes[indSplit[u]], this.checkListSlcItemCssClass);
	                        }
	                    }
	                }
	                ...
	                if ((0, _dom.byId)(tf.fltIds[colIndex] + '_0')) {
	                    (0, _dom.byId)(tf.fltIds[colIndex] + '_0').checked = false;
	                }
	            }
	
	            if (li.nodeName === itemTag) {
	                (0, _dom.removeClass)(n.childNodes[0], this.checkListSlcItemCssClass);
	                (0, _dom.addClass)(li, this.checkListSlcItemCssClass);
	            }
	        } else {
	            ...
	            if (li.nodeName === itemTag) {
	                (0, _dom.removeClass)(li, this.checkListSlcItemCssClass);
	            }
	        }
	    };
	    ...
	    CheckList.prototype.selectOptions = function selectOptions(colIndex) {
	        ...
	        for (var k = 0; k < lisNb; k++) {
	            var li = (0, _dom.tag)(flt, 'li')[k],
	                lbl = (0, _dom.tag)(li, 'label')[0],
	                chk = (0, _dom.tag)(li, 'input')[0],
	                lblTxt = (0, _string.matchCase)(getText(lbl), tf.caseSensitive);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RowsCounter = exports.RowsCounter = function (_Feature) {
	    ...
	    RowsCounter.prototype.init = function init() {
	        ...
	        var targetEl = !this.rowsCounterTgtId ? tf.lDiv : (0, _dom.id)(this.rowsCounterTgtId);
	    ...
	    RowsCounter.prototype.destroy = function destroy() {
	        ...
	        if (!this.rowsCounterTgtId && this.rowsCounterDiv) {
	            ...
	            (0, _dom.id)(this.rowsCounterTgtId).innerHTML = '';
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StatusBar = exports.StatusBar = function (_Feature) {
	    ...
	    StatusBar.prototype.init = function init() {
	        ...
	        var targetEl = !this.statusBarTgtId ? tf.lDiv : (0, _dom.id)(this.statusBarTgtId);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Paging = exports.Paging = function (_Feature) {
	    ...
	    Paging.prototype.init = function init() {
	        ...
	        var targetEl = !this.pagingTgtId ? tf.mDiv : (0, _dom.id)(this.pagingTgtId);
	        ...
	        this.pagingSlc = (0, _dom.id)(this.prfxSlcPages + tf.id);
	    ...
	    Paging.prototype.setPagingInfo = function setPagingInfo(validRows) {
	        var tf = this.tf;
	        var mdiv = !this.pagingTgtId ? tf.mDiv : (0, _dom.id)(this.pagingTgtId);
	        var pgspan = (0, _dom.id)(this.prfxPgSpan + tf.id);
	    ...
	    Paging.prototype.setResultsPerPage = function setResultsPerPage() {
	        ...
	        var targetEl = !this.resultsPerPageTgtId ? tf.rDiv : (0, _dom.id)(this.resultsPerPageTgtId);
	    ...
	    Paging.prototype.removeResultsPerPage = function removeResultsPerPage() {
	        ...
	        var slcR = this.resultsPerPageSlc,
	            slcRSpan = (0, _dom.id)(this.prfxSlcResultsTxt + tf.id);
	        if (slcR) {
	    ...
	    Paging.prototype.destroy = function destroy() {
	        ...
	        // btns containers
	        var btnNextSpan = (0, _dom.id)(this.prfxBtnNextSpan + tf.id);
	        var btnPrevSpan = (0, _dom.id)(this.prfxBtnPrevSpan + tf.id);
	        var btnLastSpan = (0, _dom.id)(this.prfxBtnLastSpan + tf.id);
	        var btnFirstSpan = (0, _dom.id)(this.prfxBtnFirstSpan + tf.id);
	        //span containing 'Page' text
	        var pgBeforeSpan = (0, _dom.id)(this.prfxPgBeforeSpan + tf.id);
	        //span containing 'of' text
	        var pgAfterSpan = (0, _dom.id)(this.prfxPgAfterSpan + tf.id);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClearButton = exports.ClearButton = function (_Feature) {
	    ...
	    ClearButton.prototype.init = function init() {
	        ...
	        var targetEl = !this.btnResetTgtId ? tf.rDiv : (0, _dom.id)(this.btnResetTgtId);
	    ...
	    ClearButton.prototype.destroy = function destroy() {
	        ...
	        var resetspan = (0, _dom.id)(this.prfxResetSpan + tf.id);
	        if (resetspan) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Help = exports.Help = function (_Feature) {
	    ...
	    Help.prototype.init = function init() {
	        ...
	        var targetEl = !this.tgtId ? tf.rDiv : (0, _dom.id)(this.tgtId);
	        targetEl.appendChild(helpspan);
	
	        var divContainer = !this.contTgtId ? helpspan : (0, _dom.id)(this.contTgtId);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoResults = exports.NoResults = function (_Feature) {
	    ...
	    NoResults.prototype.init = function init() {
	        ...
	        var tf = this.tf;
	        var target = this.customContainer || (0, _dom.id)(this.customContainerId) || tf.tbl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hash = exports.Hash = function () {
	    ...
	    Hash.prototype.init = function init() {
	        ...
	        _event2.default.add(_root.root, 'hashchange', function () {
	            return _this.sync();
	        });
	    };
	    ...
	    Hash.prototype.destroy = function destroy() {
	        ...
	        _event2.default.remove(_root.root, 'hashchange', function () {
	            return _this2.sync();
	        });
