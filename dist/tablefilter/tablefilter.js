...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "tf-" + ({}[chunkId]||chunkId) + "-" + {"0":"b8c33e0326420665b66e"}[chunkId] + ".js";
...
exports.isKeyPressed = exports.keyCode = exports.targetEvt = exports.cancelEvt = exports.stopEvt = exports.removeEvt = exports.addEvt = undefined;
 ...
 */
var isKeyPressed = exports.isKeyPressed = function isKeyPressed(evt) {
...
var TableFilter = exports.TableFilter = function () {
    ...
    function TableFilter() {
         ...
         * @type {String}
         */
        this.singleFltCssClass = (0, _settings.defaultsStr)((f.single_filter || {}).css_class, 'single_flt');
         ...
         * @type {Array}
         */
        this.externalFltIds = (0, _settings.defaultsArr)(f.external_flt_ids, []);
         ...
         * @type {Boolean|Object}
         */
        this.singleFlt = (0, _types.isObj)(f.single_filter) || Boolean(f.single_filter);
         ...
         * }
         */
        this.singleFltExcludeCols = (0, _types.isObj)(f.single_filter) && (0, _types.isArray)(f.single_filter.exclude_cols) ? f.single_filter.exclude_cols : [];
         ...
         * @type {Object|Boolean}
         */
        this.btnReset = (0, _types.isObj)(f.btn_reset) || Boolean(f.btn_reset);
         ...
         * @type {Object|Boolean}
         */
        this.autoFilter = (0, _types.isObj)(f.auto_filter) || Boolean(f.auto_filter);

        /**
         * Auto-filter delay in milliseconds
         * @type {Number}
         */
        this.autoFilterDelay = (0, _types.isObj)(f.auto_filter) && (0, _types.isNumber)(f.auto_filter.delay) ? f.auto_filter.delay : _const.AUTO_FILTER_DELAY;
    ...
    _createClass(TableFilter, [{
        ...
        value: function init() {
            ...
            if (!this.fltGrid) {
                ...
                var n = this.singleFlt ? 1 : this.nbCells;
                ...
                for (var i = 0; i < n; i++) {
                    ...
                    if (i === n - 1 && this.displayBtn) {
                        this._buildSubmitButton(this.isExternalFlt() ? (0, _dom.elm)(this.externalFltIds[i]) : fltCell);
                    }
        ...
        value: function detectKey(evt) {
            ...
            if ((0, _event.isKeyPressed)(evt, [_const.ENTER_KEY])) {
                this.filter();
        ...
        value: function onKeyUp(evt) {
            ...
            if ((0, _event.isKeyPressed)(evt, [_const.ENTER_KEY, _const.TAB_KEY, _const.ESC_KEY, _const.UP_ARROW_KEY, _const.DOWN_ARROW_KEY])) {
                _root.root.clearInterval(this.autoFilterTimer);
                this.autoFilterTimer = null;
            } else {
        ...
        value: function filter() {
            ...
            eachRow(function (row, k) {
                ...
                for (var j = 0; j < nbCells; j++) {
                    ...
                    if ((0, _types.isArray)(sA) || hasMultiOrSA || hasMultiAndSA) {
                        ...
                        for (var w = 0, len = s.length; w < len; w++) {
                            ...
                            found = _this11._match(cS, cellValue, j);
                ...
                emitter.emit('row-processed', _this11, k, _this11.validRowsIndex.length, isMatch);
            },
            // continue condition
            function (row) {
                                                ...
                                                //ends with
                                                    ...
                                                    //empty
                                                        ...
                                                        //non-empty
                                                                ...
                                                                if (numData && this.hasType(colIdx, [_const.NUMBER, _const.FORMATTED_NUMBER]) && !this.singleFlt) {
...
var ClearButton = exports.ClearButton = function (_Feature) {
    ...
    function ClearButton(tf) {
         ...
         * @type {String}
         */
        _this.text = (0, _settings.defaultsStr)(f.text, null);

        /**
         * Css class for reset button
         * @type {String}
         */
        _this.cssClass = (0, _settings.defaultsStr)(f.css_class, 'reset');
         ...
         * @type {String}
         */
        _this.html = (0, _settings.defaultsStr)(f.html, !tf.enableIcons || _this.text ? null : '<input type="button" value="" class="' + _this.cssClass + '" ' + 'title="' + _this.tooltip + '" />');
    ...
    function Paging(tf) {
        ...
        _this.evt = {
            ...
            _detectKey: function _detectKey(e) {
                if ((0, _event.isKeyPressed)(e, [_const.ENTER_KEY])) {
                    if (tf.sorted) {
                        tf.filter();
    ...
    _createClass(CheckList, [{
        ...
        value: function addChecks(colIndex, ul) {
            ...
            for (var y = 0; y < this.opts.length; y++) {
                ...
                var lblIdx = y + chkCt;
                var li = (0, _dom.createCheckItem)(fltId + '_' + lblIdx, val, lbl, ['data-idx', lblIdx]);
        ...
        value: function addTChecks(colIndex, ul) {
            ...
            var chkCt = 1;
            var fltId = tf.fltIds[colIndex];
            var li0 = (0, _dom.createCheckItem)(fltId + '_0', '', tf.getClearFilterText(colIndex), ['data-idx', 0]);
            ...
            if (tf.enableEmptyOption) {
                var li1 = (0, _dom.createCheckItem)(fltId + '_1', tf.emOperator, tf.emptyText, ['data-idx', 1]);
            ...
            if (tf.enableNonEmptyOption) {
                var li2 = (0, _dom.createCheckItem)(fltId + '_2', tf.nmOperator, tf.nonEmptyText, ['data-idx', 2]);
        ...
        value: function selectOptions(colIndex) {
            ...
            [].forEach.call(lis, function (li) {
                ...
                var chkVal = (0, _string.matchCase)(chk.value, tf.caseSensitive);

                if (chkVal !== '' && (0, _array.has)(values, chkVal, tf.caseSensitive)) {
                    chk.checked = true;
                } else {
                    // Check non-empty-text or empty-text option
                    if (values.indexOf(tf.nmOperator) !== -1 && chkVal === (0, _string.matchCase)(tf.nonEmptyText, tf.caseSensitive)) {
                        chk.checked = true;
                    } else if (values.indexOf(tf.emOperator) !== -1 && chkVal === (0, _string.matchCase)(tf.emptyText, tf.caseSensitive)) {
                        chk.checked = true;
                    } else {
                        chk.checked = false;
                    }
                }
                _this7.setCheckListValues(chk);
            });
        }
        ...
        value: function destroy() {
            ...
            this.emitter.off(['build-checklist-filter'], function (tf, colIndex, isLinked) {
                return _this8.build(colIndex, isLinked);
            });
            this.emitter.off(['select-checklist-options'], function (tf, colIndex, values) {
                return _this8.selectOptions(colIndex, values);
            });
            this.emitter.off(['rows-changed'], function () {
                return _this8.refreshAll();
            });
