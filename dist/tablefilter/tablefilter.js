	...
	var Store = exports.Store = function () {
	    ...
	    _createClass(Store, [{
	        ...
	        value: function init() {
	            ...
	            this.emitter.on(['after-changing-page'], function (tf, index) {
	                return _this.savePageNb(index);
	            });
	            this.emitter.on(['after-changing-results-per-page'], function (tf, index) {
	        ...
	        key: 'savePageNb',
	        value: function savePageNb(index) {
	            if (!this.tf.rememberPageNb) {
	                return;
	            }
	            _cookie2.default.write(this.pgNbCookie, index + 1, this.duration);
	        }
	        ...
	        value: function destroy() {
	            ...
	            this.emitter.off(['after-changing-page'], function (tf, index) {
	                return _this2.savePageNb(index);
	            });
	            this.emitter.off(['after-changing-results-per-page'], function (tf, index) {
