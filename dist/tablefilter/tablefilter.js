	        ...
	        value: function setPagingInfo() {
	            ...
	            if (validRows.length === 0) {
	                ...
	                for (var j = tf.refRow; j < tf.nbRows; j++) {
	                    ...
	                    if (_Types2['default'].isNull(isRowValid) || Boolean(isRowValid)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Help = (function () {
	    ...
	    function Help(tf) {
	        ...
	        //defines help text
	        this.instrText = f.help_instructions_text ? f.help_instructions_text : 'Use the filters above each column to filter and limit table ' + 'data. Avanced searches can be performed by using the following ' + 'operators: <br /><b>&lt;</b>, <b>&lt;=</b>, <b>&gt;</b>, ' + '<b>&gt;=</b>, <b>=</b>, <b>*</b>, <b>!</b>, <b>{</b>, <b>}</b>, ' + '<b>||</b>,<b>&amp;&amp;</b>, <b>[empty]</b>, <b>[nonempty]</b>, ' + '<b>rgx:</b><br/> Learn more:<br/>' + '<a href="https://github.com/koalyptus/TableFilter/wiki/' + '4.-Filter-operators" target="_blank">https://github.com/' + 'koalyptus/TableFilter/wiki/4.-Filter-operators</a><hr/>';
