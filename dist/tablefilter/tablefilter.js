...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "tf-" + ({}[chunkId]||chunkId) + "-" + {"0":"0a3b38dd0c16526dcd8b"}[chunkId] + ".js";
...
var NATIVE_TYPES = __webpack_require__(153),
    ...
    isClass = __webpack_require__(72),
...
var LazyLoadedLocales = __webpack_require__(295),
    AmericanEnglishDefinition = __webpack_require__(95),
...
var _dateType = __webpack_require__(112);

var _help = __webpack_require__(115);
...
var _highlightKeywords = __webpack_require__(116);

var _popupFilter = __webpack_require__(121);

var _markActiveColumns = __webpack_require__(118);

var _rowsCounter = __webpack_require__(122);

var _statusBar = __webpack_require__(124);

var _clearButton = __webpack_require__(111);

var _alternateRows = __webpack_require__(110);

var _noResults = __webpack_require__(119);

var _paging = __webpack_require__(120);
...
var mathAliases = __webpack_require__(7);
...
var setDate = __webpack_require__(35),
    ...
    mathAliases = __webpack_require__(7);
...
var getDaysInMonth = __webpack_require__(86);
...
var isDefined = __webpack_require__(27),
    ...
    walkUnitDown = __webpack_require__(94);
...
var LocaleHelpers = __webpack_require__(8),
    DateUnitIndexes = __webpack_require__(5),
    moveToEndOfWeek = __webpack_require__(90),
    getLowerUnitIndex = __webpack_require__(39),
    setUnitAndLowerToEdge = __webpack_require__(36);
...
var MINUTES = __webpack_require__(98),
    ParsingTokens = __webpack_require__(99),
    LocaleHelpers = __webpack_require__(8),
    DateUnitIndexes = __webpack_require__(5),
    ...
    resetTime = __webpack_require__(92),
    isDefined = __webpack_require__(27),
    setWeekday = __webpack_require__(24),
...
var ISODefaults = __webpack_require__(63),
    ...
    moveToEndOfWeek = __webpack_require__(90),
    moveToBeginningOfWeek = __webpack_require__(62),
    moveToFirstDayOfWeekYear = __webpack_require__(91);
...
var classChecks = __webpack_require__(3),
    ...
    incrementDate = __webpack_require__(105),
    ...
    getDateIncrementObject = __webpack_require__(103);
...
var updateDate = __webpack_require__(50),
    collectDateArguments = __webpack_require__(78);
...
var CoreOutputFormats = __webpack_require__(96),
    formattingTokens = __webpack_require__(297),
    assertDateIsValid = __webpack_require__(77);
...
var LocaleHelpers = __webpack_require__(8),
    dateFormat = __webpack_require__(81),
    classChecks = __webpack_require__(3),
    assertDateIsValid = __webpack_require__(77),
...
var LocaleHelpers = __webpack_require__(8),
    ...
    dateIsValid = __webpack_require__(45),
    classChecks = __webpack_require__(3),
    compareDate = __webpack_require__(79);
...
var classChecks = __webpack_require__(3),
    getRangeMemberPrimitiveValue = __webpack_require__(104);
...
var MULTIPLIERS = __webpack_require__(106),
    callDateSet = __webpack_require__(32),
    callDateGet = __webpack_require__(18);
...
var _sugarDate = __webpack_require__(100);
...
var GridLayout = exports.GridLayout = function (_Feature) {
    ...
    function GridLayout(tf) {
         ...
         * @type {String}
         */
        _this.width = f.width || null;

        /**
         * Grid-layout container height as CSS string
         * @type {String}
         */
        _this.height = f.height || null;

        /**
         * Css class for main container element
         * @type {String}
         */
        _this.mainContCssClass = f.cont_css_class || 'grd_Cont';

        /**
         * Css class for body table container element
         * @type {String}
         */
        _this.contCssClass = f.tbl_cont_css_class || 'grd_tblCont';

        /**
         * Css class for headers table container element
         * @type {String}
         */
        _this.headContCssClass = f.tbl_head_css_class || 'grd_headTblCont';

        /**
         * Css class for toolbar container element (rows counter, paging etc.)
         * @type {String}
         */
        _this.infDivCssClass = f.inf_grid_css_class || 'grd_inf';

        /**
         * Index of the headers row, default: 0
         * @type {Number}
         */
        _this.headRowIndex = f.headers_row_index || 0;

        /**
         * Collection of the header row indexes to be moved into headers table
         * @type {Array}
         */
        _this.headRows = f.headers_rows || [0];

        /**
         * Enable or disable column filters generation, default: true
         * @type {Boolean}
         */
        _this.filters = f.filters === false ? false : true;
         ...
         * @type {String}
         */
        _this.defaultColWidth = f.default_col_width || '100px';
    ...
    _createClass(GridLayout, [{
        ...
        value: function init() {
            ...
            this.emitter.on(['column-hidden'], function (tf, extension, colIndex /*, hiddenCols*/) {
                ...
                var headTblW = parseInt(_this2.headTbl.style.width, 10);
                var hiddenWidth = parseInt(_this2.colElms[colIndex].style.width, 10);
                _this2.headTbl.style.width = headTblW - hiddenWidth + 'px';
                tbl.style.width = _this2.headTbl.style.width;
            });

            this.emitter.on(['column-shown'], function (tf, extension, colIndex /*, hiddenCols*/) {
                var width = parseInt(_this2.colElms[colIndex].style.width, 10);
                // let headCols = tag(this.headTbl, 'col');
                ...
                _this2.headTbl.style.width = headTblW + width + 'px';
                tbl.style.width = _this2.headTbl.style.width;
            });
...
var Help = exports.Help = function (_Feature) {
        ...
        function Help(tf) {
                 ...
                 * @type {String}
                 */
                _this.tgtId = f.target_id || null;

                /**
                 * ID of custom container element for instructions
                 * @type {String}
                 */
                _this.contTgtId = f.container_target_id || null;
                 ...
                 * @type {String}
                 */
                _this.btnCssClass = f.btn_css_class || 'helpBtn';

                /**
                 * Css class for help container element
                 * @type {String}
                 */
                _this.contCssClass = f.container_css_class || 'helpCont';
...
var Loader = exports.Loader = function (_Feature) {
    ...
    function Loader(tf) {
         ...
         * @type {String}
         */
        _this.text = f.text || 'Loading...';

        /**
         * Custom HTML injected in Loader's container element
         * @type {String}
         */
        _this.html = f.html || null;

        /**
         * Css class for Loader's container element
         * @type {String}
         */
        _this.cssClass = f.css_class || 'loader';
...
var Paging = exports.Paging = function (_Feature) {
    ...
    function Paging(tf) {
         ...
         * @type {String}
         */
        _this.btnCssClass = f.btn_css_class || 'pgInp';
        ...
        */
         ...
         * @type {Number}
         */
        _this.pageLength = !isNaN(f.length) ? f.length : 10;

        /**
         * ID of custom container element for the results per page selector
         * @type {String}
         */
        _this.pageLengthTgtId = f.results_per_page_target_id || null;

        /**
         * Css class for the paging select element
         * @type {String}
         */
        _this.pgSlcCssClass = f.slc_css_class || 'pgSlc';

        /**
         * Css class for the paging input element
         * @type {String}
         */
        _this.pgInpCssClass = f.inp_css_class || 'pgNbInp';
         ...
         * @type {String}
         */
        _this.btnNextPageHtml = f.btn_next_page_html || (!tf.enableIcons ? null : '<input type="button" value="" class="' + _this.btnCssClass + ' nextPage" title="Next page" />');

        /**
         * Previous page button HTML
         * @type {String}
         */
        _this.btnPrevPageHtml = f.btn_prev_page_html || (!tf.enableIcons ? null : '<input type="button" value="" class="' + _this.btnCssClass + ' previousPage" title="Previous page" />');

        /**
         * First page button HTML
         * @type {String}
         */
        _this.btnFirstPageHtml = f.btn_first_page_html || (!tf.enableIcons ? null : '<input type="button" value="" class="' + _this.btnCssClass + ' firstPage" title="First page" />');

        /**
         * Last page button HTML
         * @type {String}
         */
        _this.btnLastPageHtml = f.btn_last_page_html || (!tf.enableIcons ? null : '<input type="button" value="" class="' + _this.btnCssClass + ' lastPage" title="Last page" />');
         ...
         * @type {Boolean}
         */
        _this.hasBtns = f.btns === false ? false : true;
...
var PopupFilter = exports.PopupFilter = function (_Feature) {
    ...
    function PopupFilter(tf) {
         ...
         * @type {Boolean}
         */
        _this.closeOnFiltering = f.close_on_filtering === false ? false : true;

        /**
         * Filter icon path
         * @type {String}
         */
        _this.iconPath = f.image || tf.themesPath + 'icn_filter.gif';

        /**
         * Active filter icon path
         * @type {string}
         */
        _this.activeIconPath = f.image_active || tf.themesPath + 'icn_filterActive.gif';

        /**
         * HTML for the filter icon
         * @type {string}
         */
        _this.iconHtml = f.image_html || '<img src="' + _this.iconPath + '" alt="Column filter" />';

        /**
         * Css class assigned to the popup container element
         * @type {String}
         */
        _this.placeholderCssClass = f.placeholder_css_class || 'popUpPlaceholder';

        /**
         * Css class assigned to filter container element
         * @type {String}
         */
        _this.containerCssClass = f.div_css_class || 'popUpFilter';
         ...
         * @type {Boolean}
         */
        _this.adjustToContainer = f.adjust_to_container === false ? false : true;
...
var StatusBar = exports.StatusBar = function (_Feature) {
    ...
    function StatusBar(tf) {
         ...
         * @type {String}
         */
        _this.cssClass = f.css_class || 'status';
    ...
    _createClass(TableFilter, [{
        ...
        value: function instantiateFeatures() {
            ...
            features.forEach(function (feature) {
                ...
                if (_this5[feature.property] === true || feature.enforce === true) {
...
var isClass = __webpack_require__(72),
    isObjectType = __webpack_require__(53),
...
var Sugar = __webpack_require__(0),
    advanceDateWithArgs = __webpack_require__(76);
...
var Sugar = __webpack_require__(0),
    getDaysInMonth = __webpack_require__(86);
...
var Sugar = __webpack_require__(0),
    createDateWithContext = __webpack_require__(80);
...
var Sugar = __webpack_require__(0),
    getUTCOffset = __webpack_require__(89);
...
var LocaleHelpers = __webpack_require__(8),
    spaceSplit = __webpack_require__(43),
    fullCompareDate = __webpack_require__(83),
    namespaceAliases = __webpack_require__(22),
    defineInstanceSimilar = __webpack_require__(41);
...
var callDateSet = __webpack_require__(32),
    setISOWeekNumber = __webpack_require__(93);
...
var getDateParamKey = __webpack_require__(85);
...
var getNewDate = __webpack_require__(40),
    mathAliases = __webpack_require__(7),
    getAdjustedUnit = __webpack_require__(84),
    getTimeDistanceForUnit = __webpack_require__(59);
...
var trunc = __webpack_require__(23),
    withPrecision = __webpack_require__(74),
    getAdjustedUnit = __webpack_require__(84);
...
var LocaleHelpers = __webpack_require__(8),
    trunc = __webpack_require__(23),
    getHours = __webpack_require__(87);
...
var LOCALE_ARRAY_FIELDS = __webpack_require__(294),
    ...
    LocalizedParsingTokens = __webpack_require__(97),
    ...
    getRegNonCapturing = __webpack_require__(88),
    coreUtilityAliases = __webpack_require__(10),
...
var LocalizedParsingTokens = __webpack_require__(97),
    getRegNonCapturing = __webpack_require__(88);
...
var Sugar = __webpack_require__(0),
    dateRelative = __webpack_require__(82);
...
var LocaleHelpers = __webpack_require__(8),
    ...
    CoreOutputFormats = __webpack_require__(96),
    forEach = __webpack_require__(26),
    padNumber = __webpack_require__(54),
    spaceSplit = __webpack_require__(43),
    namespaceAliases = __webpack_require__(22),
...
var withPrecision = __webpack_require__(74);
...
var chr = __webpack_require__(75);
