	        ...
	        value: function setFilterValue(index) {
	            ...
	            //multiple selects
	                ...
	                //checklist
	                        ...
	                        var values = searcharg.split(' ' + this.orOperator + ' ');
	        ...
	        value: function linkFilters() {
	            ...
	            for (var i = 0, len = slcIndex.length; i < len; i++) {
	                ...
	                if (activeFlt !== slcIndex[i] || this.paging && slcA1.indexOf(slcIndex[i]) != -1 && activeFlt === slcIndex[i] || !this.paging && (slcA3.indexOf(slcIndex[i]) != -1 || slcA2.indexOf(slcIndex[i]) != -1) || slcSelectedValue === this.displayAllText) {
	                    ...
	                    if (slcA3.indexOf(slcIndex[i]) != -1) {
	                        this.emitter.emit('build-checklist-filter', this, slcIndex[i], this.isExternalFlt);
	                    } else {
	                        this.emitter.emit('build-select-filter', this, slcIndex[i], true, this.isExternalFlt);
	                    }
	...
	var Store = exports.Store = (function () {
	    ...
	    _createClass(Store, [{
	        ...
	        value: function init() {
	            ...
	            this.emitter.on(['after-filtering'], function () {
	                return _this.saveFilterValues(_this.tf.fltsValuesCookie);
	            });
	        ...
	        value: function clearCookies() {
	            _cookie2.default.remove(this.tf.fltsValuesCookie);
	            _cookie2.default.remove(this.tf.pgLenCookie);
	            _cookie2.default.remove(this.tf.pgNbCookie);
	        }
	    }, {
	        key: 'destroy',
	        value: function destroy() {
	            ...
	            this.emitter.off(['after-filtering'], function () {
	                return _this2.saveFilterValues(_this2.tf.fltsValuesCookie);
	            });
	...
	var GridLayout = exports.GridLayout = (function (_Feature) {
	    ...
	    _createClass(GridLayout, [{
	        ...
	        value: function init() {
	            ...
	            var tblW = undefined; //initial table width
	            if (tbl.width !== '') {
	                tblW = tbl.width;
	...
	var Loader = exports.Loader = (function (_Feature) {
	    ...
	    _createClass(Loader, [{
	        ...
	        value: function init() {
	            ...
	            // Subscribe to events
	            emitter.on(['before-filtering', 'before-populating-filter', 'before-changing-page', 'before-clearing-filters', 'before-changing-results-per-page', 'before-reset-page', 'before-reset-page-length', 'before-loading-extensions', 'before-loading-themes'], function () {
	                return _this2.show('');
	            });
	            emitter.on(['after-filtering', 'after-populating-filter', 'after-changing-page', 'after-clearing-filters', 'after-changing-results-per-page', 'after-reset-page', 'after-reset-page-length', 'after-loading-extensions', 'after-loading-themes'], function () {
	        ...
	        value: function destroy() {
	            ...
	            // Unsubscribe to events
	            emitter.off(['before-filtering', 'before-populating-filter', 'before-changing-page', 'before-clearing-filters', 'before-changing-results-per-page', 'before-reset-page', 'before-reset-page-length', 'before-loading-extensions', 'before-loading-themes'], function () {
	                return _this4.show('');
	            });
	            emitter.off(['after-filtering', 'after-populating-filter', 'after-changing-page', 'after-clearing-filters', 'after-changing-results-per-page', 'after-reset-page', 'after-reset-page-length', 'after-loading-extensions', 'after-loading-themes'], function () {
	    ...
	    _createClass(HighlightKeyword, [{
	        ...
	        value: function destroy() {
	            ...
	            this.emitter.off(['highlight-keyword'], function (tf, cell, word) {
	                return _this2.highlight(cell, word, _this2.highlightCssClass);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dropdown = exports.Dropdown = (function (_Feature) {
	    ...
	    function Dropdown(tf) {
	        ...
	        _this.slcFillingMethod = f.slc_filling_method || 'createElement';
	                ...
	                for (var j = 0; j < nchilds; j++) {
	                    ...
	                    if (colIndex === j && (!isLinked || isLinked && tf.disableExcludedOptions) || colIndex == j && isLinked && (rows[k].style.display === '' && !tf.paging || tf.paging && (!tf.validRowsIndex || tf.validRowsIndex && tf.validRowsIndex.indexOf(k) != -1) && (activeFlt === undefined || activeFlt == colIndex || activeFlt != colIndex && tf.validRowsIndex.indexOf(k) != -1))) {
	                        ...
	                        if (isLinked && tf.disableExcludedOptions) {
	                            ...
	                            if (!_array2.default.has(filteredCol, cell_string, matchCase) && !_array2.default.has(excludedOpts, cell_string, matchCase)) {
	    ...
	    _createClass(CheckList, [{
	                ...
	                for (var j = 0; j < ncells; j++) {
	                    ...
	                    if (colIndex === j && (!tf.linkedFilters || tf.linkedFilters && tf.disableExcludedOptions) || colIndex === j && tf.linkedFilters && (rows[k].style.display === '' && !tf.paging || tf.paging && (!activeFlt || activeFlt === colIndex || activeFlt != colIndex && tf.validRowsIndex.indexOf(k) != -1))) {
	                        ...
	                        if (tf.linkedFilters && tf.disableExcludedOptions) {
	                            ...
	                            if (!_array2.default.has(filteredCol, cell_string, tf.matchCase) && !_array2.default.has(this.excludedOpts, cell_string, tf.matchCase)) {
	        ...
	        value: function selectOptions(colIndex) {
	            ...
	            for (var k = 0; k < lisNb; k++) {
	                ...
	                if (lblTxt !== '' && _array2.default.has(values, lblTxt, true)) {
	                    chk.checked = true;
	...
	var StatusBar = exports.StatusBar = (function (_Feature) {
	    ...
	    _createClass(StatusBar, [{
	        ...
	        value: function init() {
	            ...
	            emitter.on(['before-changing-page'], function () {
	            ...
	            emitter.on(['before-changing-results-per-page'], function () {
	        ...
	        value: function destroy() {
	            ...
	            emitter.off(['before-changing-page'], function () {
	            ...
	            emitter.off(['before-changing-results-per-page'], function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Paging = exports.Paging = (function (_Feature) {
	    ...
	    _createClass(Paging, [{
	        ...
	        key: 'resetPageLength',
	        value: function resetPageLength(name) {
	            var tf = this.tf;
	            if (!this.isEnabled()) {
	                return;
	            }
